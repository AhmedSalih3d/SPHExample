...
begin
    ...
    SimMetaData  = SimulationMetaData{D, T}(
                                    ...
                                    SaveLocation=raw"E:\SecondApproach\StillWedge", 
                                    SimulationTime=4, #seconds
                                    OutputEach=0.01,  #seconds
    )
    # Initialze the constants to use
    SimConstants = SimulationConstants{T}(c₀=42.48576250492629)
    ...
    RunSimulation(
        ...
        BoundCSV     = "./input/StillWedge_Bound_Dp0.02_LowResolution.csv",
