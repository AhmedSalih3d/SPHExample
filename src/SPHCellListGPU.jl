module SPHCellListGPU

export RunSimulationGPU


using Parameters, FastPow, StaticArrays, Base.Threads, ChunkSplitters, CUDA
...
###=== Function to process each cell and its neighbors
    ...
    ###===
    function RunSimulationGPU(;SimGeometry::Vector{Geometry{Dimensions, FloatType}}, #Don't further specify type for now
